...
export interface UserPreferences {
  ...
  gymNotificationsEnabled?: boolean
  sleepAlarmEnabled?: boolean
  sleepAlarmAfterHours?: number
  sleepAlarmSound?: 'loud' | 'classic' | 'bell' | 'soft'
  sleepAlarmVibration?: 'off' | 'normal' | 'strong'
  sleepAlarmGradualVolume?: boolean
  sleepAlarmSnoozeMinutes?: number
  sleepAlarmMaxSnoozes?: number
}
