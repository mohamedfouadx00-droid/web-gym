...
function Guard({ children }: { children: ReactNode }) {
  if (!appSettings.onboardingCompleted || !appSettings.activeUserId) return <Navigate to="/onboarding" replace />
  return <>{children}</>
}
  ...
  return (
    <Routes>
      ...
      <Route element={<Guard><Shell /></Guard>}>
        ...
        <Route path="/nutrition" element={<Navigate to="/food" replace />} />
      </Route>
